<template>
      ...
      <template v-if="activeTab === 'inbox'">
        ...
        >
          <template #renderItem="{ item }">
            <UiListItem class="msg-item" :class="{ 'msg-item--unread': !item.isRead }">
              <UiListItemMeta>
                <template #title>
      ...
      <template v-else-if="activeTab === 'announcement'">
        ...
        >
          <template #field-unreadOnly>
            <UiCheckbox v-model="announcementFilter.unreadOnly">仅未读</UiCheckbox>
          </template>
        </UiFilterBar>
  ...
  <UiDrawer
    ...
    placement="right"
  >
    <UiSpin :spinning="messageDetailLoading">
      ...
      <UiEmpty size="sm" v-else description="无消息详情" />
    </UiSpin>
  </UiDrawer>
  ...
  <UiDrawer
    ...
    placement="right"
  >
    <UiSpin :spinning="announcementDetailLoading">
      ...
      <UiEmpty size="sm" v-else description="无公告详情" />
    </UiSpin>
  </UiDrawer>
</template>
...
const messageTabItems = computed(() => [
  {
    key: 'inbox',
    label: '我的消息',
    count: unreadInboxCount.value > 0 ? unreadInboxCount.value : undefined,
    badgeTone: (unreadInboxCount.value > 0 ? 'red' : 'gray') as ToneCode,
  },
  {
    key: 'announcement',
    label: '系统公告',
    count: unreadAnnouncementCount.value > 0 ? unreadAnnouncementCount.value : undefined,
    badgeTone: (unreadAnnouncementCount.value > 0 ? 'red' : 'gray') as ToneCode,
  },
])
...
function formatMessageType(type: NotificationTypeEnum): string {
  const map: Record<NotificationTypeEnum, string> = {
    ...
    [NotificationTypeEnum.PORTFOLIO_ARCHIVE_REVIEW_ESCALATED]: '档案审核转复审',
    [NotificationTypeEnum.PORTFOLIO_ARCHIVE_REVIEW_PENDING]: '档案提交待审',
    ...
    [NotificationTypeEnum.PORTFOLIO_GAP_LIFECYCLE_RESUMED]: '补采生命周期恢复',
    [NotificationTypeEnum.PORTFOLIO_REVIEW_LIFECYCLE_SUSPENDED]: '审核生命周期挂起',
    [NotificationTypeEnum.PORTFOLIO_REVIEW_LIFECYCLE_RESUMED]: '审核生命周期恢复',
    ...
    [NotificationTypeEnum.PORTFOLIO_EVALUATION_ARCHIVED]: '评价结果已归档',
    [NotificationTypeEnum.PORTFOLIO_EVALUATION_CLOSED]: '评价任务已关闭',
    [NotificationTypeEnum.PORTFOLIO_EVALUATION_SUSPENDED]: '评价任务已暂停',
    [NotificationTypeEnum.PORTFOLIO_EVALUATION_RESUMED]: '评价任务已恢复',
    [NotificationTypeEnum.PORTFOLIO_EVALUATION_LIFECYCLE_SUSPENDED]: '评价生命周期暂停',
    [NotificationTypeEnum.PORTFOLIO_EVALUATION_LIFECYCLE_RESUMED]: '评价生命周期恢复',
    [NotificationTypeEnum.PORTFOLIO_EVALUATION_STAGE_SUBJECT]: '评价阶段进展',
    [NotificationTypeEnum.PORTFOLIO_EVALUATION_STAGE_REVIEWER]: '评价阶段待办',
    [NotificationTypeEnum.PORTFOLIO_EVALUATION_VOIDED]: '评价任务已作废',
    [NotificationTypeEnum.PORTFOLIO_EVALUATION_PUBLISHED]: '评价任务已发布',
    [NotificationTypeEnum.PORTFOLIO_EVALUATION_MATERIAL_ALL_CONFIRMED]: '评价材料全员已确认',
    [NotificationTypeEnum.PORTFOLIO_EVALUATION_MATERIAL_CONFIRM_BROKEN]: '评价材料确认齐套已打破',
    [NotificationTypeEnum.PORTFOLIO_EVALUATION_CORRECTION_STARTED]: '评价更正复核启动',
    [NotificationTypeEnum.PORTFOLIO_EVALUATION_CORRECTION_COMPLETED]: '评价更正复核完成',
    [NotificationTypeEnum.PORTFOLIO_EVALUATION_CORRECTION_CANCELLED]: '评价更正复核已撤销',
    [NotificationTypeEnum.PORTFOLIO_EVALUATION_CORRECTION_ORDER_COMPLETED]:
      '评价更正复核工单已完成',
    [NotificationTypeEnum.PORTFOLIO_EVALUATION_PUBLICITY_EXPIRED]: '评价公示期已结束',
    [NotificationTypeEnum.PORTFOLIO_EVALUATION_OBJECTIONS_CLEARED]: '评价异议已全部办结',
    [NotificationTypeEnum.PORTFOLIO_TEACHER_LIFECYCLE_CHANGED]: '教师生命周期变更',
    [NotificationTypeEnum.PORTFOLIO_TEACHER_LIFECYCLE_DECLARE_PENDING]: '生命周期自助申报待审',
    [NotificationTypeEnum.PORTFOLIO_TEACHER_LIFECYCLE_DECLARE_APPROVED]: '生命周期自助申报已通过',
    [NotificationTypeEnum.PORTFOLIO_TEACHER_LIFECYCLE_DECLARE_REJECTED]: '生命周期自助申报已驳回',
    [NotificationTypeEnum.PORTFOLIO_RULE_CHANGE]: '档案袋规则变更',
    [NotificationTypeEnum.PORTFOLIO_SOURCE_FIX_RECOMPUTE]: '源修复重算完成',
    ...
    [NotificationTypeEnum.PORTFOLIO_DUAL_TEACHER_COLLEGE_PENDING]: '双师认定待院审',
    [NotificationTypeEnum.PORTFOLIO_DUAL_TEACHER_RETURNED]: '双师认定退回补正',
    [NotificationTypeEnum.PORTFOLIO_DUAL_TEACHER_ACADEMIC_PENDING]: '双师认定待教务审',
    [NotificationTypeEnum.PORTFOLIO_DUAL_TEACHER_APPROVED]: '双师认定已通过',
    [NotificationTypeEnum.PORTFOLIO_DUAL_TEACHER_REJECTED]: '双师认定已驳回',
    [NotificationTypeEnum.PORTFOLIO_TITLE_PROMOTION_COLLEGE_PENDING]: '职称申报待院审',
    [NotificationTypeEnum.PORTFOLIO_TITLE_PROMOTION_RETURNED]: '职称申报退回补正',
    [NotificationTypeEnum.PORTFOLIO_TITLE_PROMOTION_HR_PENDING]: '职称申报待人事复审',
    [NotificationTypeEnum.PORTFOLIO_TITLE_PROMOTION_REJECTED]: '职称申报已驳回',
    [NotificationTypeEnum.PORTFOLIO_TITLE_PROMOTION_PUBLICITY]: '职称申报进入公示',
    [NotificationTypeEnum.PORTFOLIO_TITLE_PROMOTION_ARCHIVED]: '职称申报公示归档',
    [NotificationTypeEnum.PORTFOLIO_TITLE_PROMOTION_EXPERT_PENDING]: '职称申报待专家评审',
...
.msg-item {
  &--unread {
    :deep(.ant-list-item) {
      ...
      box-shadow: inset 0 0 0 1px color-mix(in srgb, var(--dp-color-primary) 35%, transparent);
    }
  }
