...
import type { PortfolioAffiliationChangeTypeCode } from '@/apis/portfolio/enums'
import type {
...
async function applyLifecycleChange() {
  ...
  if (
    (lifecycleChangeType.value === PortfolioTeacherLifecycleChangeTypeCode.TRANSFERRED_OUT
      || lifecycleChangeType.value === PortfolioTeacherLifecycleChangeTypeCode.CANCEL_TRANSFER_OUT)
