...
const columns: ColumnsType = [
  ...
  { title: '基本工资', dataIndex: 'baseAmountDisplay', key: 'baseAmountDisplay', width: 100 },
  { title: '绩效工资', dataIndex: 'performanceAmountDisplay', key: 'performanceAmountDisplay', width: 100 },
  { title: '津贴', dataIndex: 'allowanceAmountDisplay', key: 'allowanceAmountDisplay', width: 100 },
...
async function saveSalary() {
  if (!form.teacherUserId.trim() || !form.salaryMonth.trim()) {
    message.warning('请填写教师 ID 与薪酬月份')
    return
  }
  try {
