...
import {
  PortfolioContentGenerateSceneCode,
  PortfolioContentGenerateSceneDescription,
...
const submitForm = reactive({
  generateScene: PortfolioContentGenerateSceneCode.LESSON_PLAN_FRAME,
  generateBrief: '',
  sourceText: '',
  evaluationSummary: '',
        ...
        <UiForm layout="vertical" class="ai-assistants__params-form">
          <UiFormItem v-if="activeKey === 'generate'" label="生成场景" required>
            <UiSelect
              ...
              size="sm"
              :options="[
                { value: PortfolioContentGenerateSceneCode.LESSON_PLAN_FRAME, label: PortfolioContentGenerateSceneDescription.LESSON_PLAN_FRAME },
                { value: PortfolioContentGenerateSceneCode.COURSE_DESCRIPTION, label: PortfolioContentGenerateSceneDescription.COURSE_DESCRIPTION },
                { value: PortfolioContentGenerateSceneCode.REFLECTION_PROMPT, label: PortfolioContentGenerateSceneDescription.REFLECTION_PROMPT },
              ]"
            />
          </UiFormItem>
