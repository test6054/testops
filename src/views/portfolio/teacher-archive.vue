...
const oneTableLoadFailed = ref(false)
...
const materialLibraryLoadFailed = ref(false)
...
function resetTeacherArchiveContext() {
  ...
  oneTableLoadFailed.value = false
  timelineLoadFailed.value = false
  detailLoadFailed.value = false
  materialLibraryLoadFailed.value = false
...
async function loadMaterialLibrary() {
  ...
  try {
    ...
    if (
      ...
      materialLibraryRows.value = []
      materialLibraryTotal.value = 0
      materialLibraryLoadFailed.value = true
  ...
  <StageWorkbenchShell>
      ...
      <div v-else class="teacher-archive__layout">
        ...
        >
          <UiDataTable
            ...
            :load-error="recordListSyncFailed"
            :total="pageTotal"
          ...
          >
            ...
            <ul class="teacher-archive__version-list">
              ...
              >
                <button
                  type="button"
                  class="teacher-archive__version-open"
    ...
    >
      <div class="teacher-archive__material-form">
        ...
        />
        <label class="teacher-archive__material-label" for="archive-support-material-file">
          材料文件
        </label>
        <UiPlatformFileField
          input-id="archive-support-material-file"
    ...
    >
      <UiDataTable
        ...
        :load-error="materialLibraryLoadFailed"
...
.teacher-archive__version-open:focus-visible {
  outline: none;
