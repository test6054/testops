    ...
    <template v-else>
      ...
      >
        ...
        <div class="scan-monitor__batch-list">
          <div
            v-for="row in batchBindRows"
            :key="row.attentionId"
            class="scan-monitor__batch-row"
            role="group"
            :aria-label="row.paperDisplayName"
          >
            ...
            <div class="scan-monitor__batch-form">
              <UiInput
                ...
                placeholder="识别学号"
                :aria-label="`${row.paperDisplayName} 识别学号`"
                :maxlength="64"
              ...
              <UiSelect
                ...
                placeholder="选择正确考生"
                :aria-label="`${row.paperDisplayName} 确认考生`"
                allow-search
                :options="candidateOptions"
                :filter-option="false"
                :loading="candidatesLoading"
