...
const deptColumns: ColumnsType<ScannerOpsDeptTimingVO> = [
  ...
  { title: '工单数', key: 'workOrderCount', dataIndex: 'workOrderCount', align: 'right', width: 96 },
  { title: '平均扫描(分钟)', key: 'avgScanDurationSeconds', dataIndex: 'avgScanDurationSeconds', align: 'right', width: 140 },
]
...
<template>
  <div class="scanner-ops-panel">
    ...
    <SignalBand v-if="signalMetrics.length" :metrics="signalMetrics" compact class="scanner-ops-panel__signal" />
