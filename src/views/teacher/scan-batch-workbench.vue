  ...
  <StageWorkbenchShell>
    ...
    <template v-else>
      ...
      <UiAlertStrip
        ...
        title="扫描批次关键指标加载失败"
        dense
        class="scan-batch-workbench__summary-alert"
      />
      ...
      <UiAlertStrip
        ...
        title="扫描设备列表加载失败"
        dense
        class="scan-batch-workbench__devices-alert"
      />
...
/** 写操作成功后由调用方本地刷新；mitt 仅通知其他活跃扫描页，避免本页自重复加载。 */
...
.scan-batch-workbench__summary-alert {
