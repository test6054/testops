...
const ROUTE_LOADERS: Record<string, () => Promise<unknown>> = {
  ...
  TeacherExamWorkspaceScanBatchDetail: () => import('@/views/teacher/scan-batch-detail-workbench.vue'),
  ...
  TeacherExamWorkspaceMarkingOrgFormalHub: () => import('@/views/admin/marking-organization/marking-org-session-hub.vue'),
  TeacherExamWorkspaceMarkingOrgTrialSessions: () => import('@/views/admin/marking-organization/trial-sessions.vue'),
  TeacherExamWorkspaceMarkingOrgFormalSessions: () => import('@/views/admin/marking-organization/formal-sessions.vue'),
  ...
  TeacherExamWorkspaceMarkingAuditTrail: () => import('@/views/admin/audit-trail.vue'),
