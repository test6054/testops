...
export enum MarkTeacherDashboardTodoTypeCode {
  ...
  SCORE_PENDING_PUBLISH_REVIEW = 'SCORE_PENDING_PUBLISH_REVIEW',
...
export const ALL_MARK_TEACHER_DASHBOARD_TODO_TYPE_CODES: readonly MarkTeacherDashboardTodoTypeCode[] = [
  ...
  MarkTeacherDashboardTodoTypeCode.SCORE_PENDING_PUBLISH_REVIEW,
...
export const MarkTeacherDashboardTodoTypeDescription: Record<MarkTeacherDashboardTodoTypeCode, string> = {
  ...
  [MarkTeacherDashboardTodoTypeCode.SCORE_UNPUBLISHED]: '待提交发布复核 {n} 份',
  [MarkTeacherDashboardTodoTypeCode.SCORE_PENDING_PUBLISH_REVIEW]: '成绩待签审发布 {n} 份',
