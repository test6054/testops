...
const props = withDefaults(
  defineProps<{
    ...
    scorePanel?: ExamWorkbenchScorePanelResponse | null
...
const viewModel = computed(() =>
  buildScoreConfirmReadinessViewModel(props.overview, props.scorePanel ?? null),
)
...
const safeConfirmableCount = computed(() => {
  if (viewModel.value.safeConfirmableCount > 0) {
    return viewModel.value.safeConfirmableCount
  }
  return props.overview?.safeConfirmableCount ?? 0
})
