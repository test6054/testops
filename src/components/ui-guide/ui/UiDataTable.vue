...
:deep(
  .ant-table-thead,
  > tr,
  > th.ant-table-selection-column .ant-checkbox-input:focus-visible + .ant-checkbox-inner
) {
...
:deep(
  .ant-table-thead,
  > tr > th.ant-table-selection-column .ant-checkbox-wrapper:hover .ant-checkbox-inner
) {
